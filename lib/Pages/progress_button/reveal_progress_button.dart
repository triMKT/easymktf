...
import 'package:easymktf/Pages/progress_button/reveal_progress_button_painter.dart';
import 'package:easymktf/Pages/progress_button/progress_button.dart';
    ...
    _animation = Tween(begin: 0.0, end: 1.0).animate(_controller)
      ...
      ..addStatusListener((AnimationStatus state) {
        if (state == AnimationStatus.completed) {
          Navigation.navigateTo(context, 'home_widget',
